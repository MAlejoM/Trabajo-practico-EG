...
<div class="menuLateral">
  <?php if ($is_logged_in): ?>
    <?php if ($is_personal): ?>
      ...
      <?php else: ?>
        <a href="<?php echo BASE_URL; ?>public/catalogo_list.php" class='btn btn-success mb-2 w-100'>CATÁLOGO</a>
        <a href="<?php echo BASE_URL; ?>public/novedad_list.php" class='btn btn-success mb-2 w-100'>NOVEDADES</a>
        <a href="<?php echo BASE_URL; ?>public/mascota_list.php" class='btn btn-success mb-2 w-100'>MASCOTAS</a>
        <a href="<?php echo BASE_URL; ?>public/atencion_list.php" class='btn btn-success mb-2 w-100'>ATENCIONES</a>
      <?php endif; ?>
