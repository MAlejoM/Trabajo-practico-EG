    ...
    if (DEV_MODE) {
        ...
        <head>
            ...
            <style>
                ...
                .error-location { background: #e3f2fd; padding: 15px; border-left: 4px solid #1976d2; margin: 20px 0; }
                .stack-trace { background: #f5f5f5; padding: 15px; border: 1px solid #ddd; overflow-x: auto; }
