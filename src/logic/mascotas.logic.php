...
if ($resultados) {
  ...
  if (isset($resultados['dni_cliente']) && $resultados['dni_cliente'] == $_SESSION['dni']) {
    echo '<a href="../../procesos/p_carga_mascota.php?eliminar=1&id_mascota=' . $id_mascota . '">Eliminar mascota</a>';
    echo '<a href="../../procesos/p_carga_mascota.php?eliminar=2&id_mascota=' . $id_mascota . '">Fallecio</a>';
