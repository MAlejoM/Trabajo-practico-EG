                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  <div class="card h-100 shadow-sm border-0">
                    <?php if (!empty($mascota['foto'])): ?>
                      <img src="data:image/jpeg;base64,<?php echo base64_encode($mascota['foto']); ?>" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Mascota - <?php echo htmlspecialchars($mascota['nombre'] . ' - ' . $mascota['raza']); ?>">
                    <?php else: ?>
