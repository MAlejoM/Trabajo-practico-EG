      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="<?php echo BASE_URL; ?>mascotas/crear.php?cliente_id=<?php echo $usuario['cliente_id']; ?>" class="btn btn-success btn-sm">
            <i class="fas fa-plus me-1" aria-hidden="true"></i> Nueva Mascota
          </a>
        </div>
        <div class="card-body text-dark">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  <div class="card h-100 shadow-sm border-0">
                    <?php if (!empty($mascota['foto'])): ?>
                      <img src="data:image/jpeg;base64,<?php echo base64_encode($mascota['foto']); ?>" class="card-img-top" style="height: 180px; object-fit: cover;" alt="Mascota - <?php echo htmlspecialchars($mascota['nombre'] . ' - ' . $mascota['raza']); ?>" title="<?php echo htmlspecialchars($mascota['nombre'] . ' - ' . $mascota['raza']); ?>" role="img">
                    <?php else: ?>
          ...
          <div class="mt-4 pt-3 border-top">
            <a href="editar.php?id=<?php echo $usuario_id; ?>" class="btn btn-link text-decoration-none ps-0">
              <i class="fas fa-arrow-left me-1" aria-hidden="true"></i> Volver a Usuario
            </a>
          </div>
        </div>
      </div>
